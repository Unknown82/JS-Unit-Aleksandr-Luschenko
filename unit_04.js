...
let myBoxFive = document.querySelector('.i-5');
let outFive = document.querySelector('.out-5');

function f5() {
    let a = myBoxFive.checked;
    if (a) {
        outFive.innerHTML = myBoxFive.value;
    }
    else {
        outFive.innerHTML = a;
    }
...
let inputPass = document.querySelector('.i-7');
let outSeven = document.querySelector('.out-71');
let outSeven2 = document.querySelector('.out-72');

function f7() {
    let a = inputPass.value;
    outSeven.innerHTML = a;
    if (a.length >= 6) {
        outSeven2.innerHTML = 1;
    }
    else if (a.length < 6) {
        outSeven2.innerHTML = 0;
    }
    else {
...
function f8() {
    outEight.innerHTML += '<input type="text" class="i-81">';
    outEight.innerHTML += '<button class="b-81">Task-8</button>';
    outEight.innerHTML += '<div class="out-81"></div>';

    let inputEightOne = document.querySelector('.i-81');
    let outEightOne = document.querySelector('.out-81');

    document.querySelector('.b-81').onclick = f81;
       function f81 () {
           let a = inputEightOne.value;

           outEightOne.innerHTML = a;
       }
}
...
let inputNine = document.querySelector('.r-9');
let outNine = document.querySelector('.out-9');

function f9() {
    let a = inputNine.checked;
    if (a) {
...
function f10() {
    ...
    outTen.style.backgroundColor = a;
}
...
let inputEleven = document.querySelector('.i-111');
let inputEleven2 = document.querySelector('.i-112');

function f11() {
    let a = inputEleven.value;

    inputEleven2.value = a;
}

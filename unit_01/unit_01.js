...
document.querySelector('.three').innerHTML = '<h3>Hallo Aleksandr wie gehts Ihnen?</h3>';
...
document.querySelector('.four').innerHTML += '<h4>Hello </h4><p>World</p>';
